...
export const PRODUCT_TIMELINE_EVENT_TYPES = {
  ...
  PRICE_ACTIVATED: "PRICE_ACTIVATED",
  PRICE_EXPIRED: "PRICE_EXPIRED",
  PRICE_ARCHIVED: "PRICE_ARCHIVED",
  /** IP-012 — offering analytics */
  ANALYTICS_REFRESHED: "ANALYTICS_REFRESHED",
  SNAPSHOT_CREATED: "SNAPSHOT_CREATED",
  METRIC_DEFINITION_UPDATED: "METRIC_DEFINITION_UPDATED",
  /** IP-013 — offering governance */
  GOVERNANCE_UPDATED: "GOVERNANCE_UPDATED",
  GOVERNANCE_OWNER_CHANGED: "GOVERNANCE_OWNER_CHANGED",
  GOVERNANCE_STEWARD_CHANGED: "GOVERNANCE_STEWARD_CHANGED",
  GOVERNANCE_READINESS_UPDATED: "GOVERNANCE_READINESS_UPDATED",
  GOVERNANCE_VALIDATION_EXECUTED: "GOVERNANCE_VALIDATION_EXECUTED",

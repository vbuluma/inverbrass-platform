...
export const PARTY_TIMELINE_EVENT_TYPES = {
  ...
  /** CRM Core (IP-001–IP-004) — distinct from generic STATUS_CHANGED / ROLE_ASSIGNED. */
  CRM_RECORD_CREATED: "CRM_RECORD_CREATED",
  CRM_OWNER_ASSIGNED: "CRM_OWNER_ASSIGNED",
  CRM_STATUS_CHANGED: "CRM_STATUS_CHANGED",
  ACCOUNT_CREATED: "ACCOUNT_CREATED",
  ACCOUNT_OWNER_CHANGED: "ACCOUNT_OWNER_CHANGED",
  CONTACT_ROLE_ASSIGNED: "CONTACT_ROLE_ASSIGNED",
 ...
 * CRM = CRM Core (records, leads, accounts, opportunities).
 * CRM_* = later BP-004 IP capability modules.
 */

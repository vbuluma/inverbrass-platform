...
export const DOCUMENT_NUMBERING_DOCUMENT_TYPES = {
  ...
  CONTRACT: "CONTRACT",
  PROCUREMENT_GOODS_RECEIPT: "PROCUREMENT_GOODS_RECEIPT",
  PROCUREMENT_ASSET_RECEIPT: "PROCUREMENT_ASSET_RECEIPT",
  PROCUREMENT_SERVICE_CONFIRMATION: "PROCUREMENT_SERVICE_CONFIRMATION",

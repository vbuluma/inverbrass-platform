/**
 * Purpose:
 * Append-only chronological history of important Party events.
 *
 * Design rationale:
 * Not an audit log or workflow history — the single Party Timeline feed.
 * Future Build Packs contribute events via PartyTimelineService.recordEvent().
 *
...
export const partyTimeline = pgTable("party_timeline", {

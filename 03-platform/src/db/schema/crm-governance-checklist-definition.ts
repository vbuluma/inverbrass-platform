/**
 * Purpose:
 * Metadata-driven CRM readiness checklist definitions (ENG-003l foundation).
 *
 * Architecture note:
 * Keyed by party_id on crm_governance until IP-01 introduces crm_record_id.
 *
...
export const crmGovernanceChecklistDefinition = pgTable(
  ...
  (table) => [
    uniqueIndex("crm_governance_checklist_business_code_uidx").on(
      table.businessId,
      table.code
    ),
  ]

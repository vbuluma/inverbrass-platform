...
export const documentTypes = [
  ...
  },
  {
    ...
    description: "Supplier qualification or certification evidence.",
    displayOrder: 16,
    isActive: true,
  },
  {
    ...
    description: "Supplier declaration for procurement qualification.",
    displayOrder: 17,
    isActive: true,
  },
  {
    code: "PROCUREMENT_COMPLIANCE",
    name: "Procurement Compliance Evidence",
    description: "Compliance evidence used for supplier qualification.",
    displayOrder: 18,
    isActive: true,
  },
  {
    code: "PURCHASE_REQUEST_SUPPORTING",
    name: "Purchase Request Supporting Document",
    description: "Supporting evidence attached to a purchase request.",
    displayOrder: 19,
    isActive: true,
  },
  {

...
const REQUIRED_FILES = [
  ...
  "drizzle/0048_bp004_ip009_case_service_request_management.sql",
  "drizzle/0050_bp004_se_final_remediation.sql",
  ...
  const results: SmokeResult[] = [
    ...
    })),
    {
      ...
      ok: (
        ...
        (entry) => entry.tag === "0048_bp004_ip009_case_service_request_management"
      ),
    },
    {
      name: "journal:0050",
      ok: (
        ...
        (entry) =>
          entry.tag === "0050_bp004_se_final_remediation" && entry.idx === 50
      ),
    },
    {
      name: "types:QUERY",

...
- How does this align with the current Architecture Version (**AV-1.6**)?
- For new Core Platform Engines: assign **ENG-003o** (next available sub-engine ID) — record in catalog §3 before implementation. No renumbering or regrouping under AV-1.5 lock.

...
| Sales, Orders & Service Delivery (old BP-005) | **BP-006**       | CRM quotations stay in BP-004 IP-10; BP-006 IP-01 converts quote → order; bookings/appointments out of scope |
...
1. **BP-006 — Sales, Orders & Service Delivery** to close Quotation (BP-004) → Convert Quote (BP-006 IP-01) → Fulfilment/Inspection, **or**
